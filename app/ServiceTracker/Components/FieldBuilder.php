 ...
 * Time: 8:15 PM
 */
/* En vez de Environment ahora hay que usar Factory, 
debido a un cambio en la versión 4.2 de Laravel ahora 
es Illuminate\View\Factory si quieren usar el componente con Laravel 4.2*/
namespace ServiceTracker\Components;
